  ...
  <div>
    <div class="flex justify-between items-center mb-6">
      ...
      <div class="flex items-center space-x-4">
        ...
        >
          <span :class="['w-2 h-2 rounded-full mr-2', autoRefresh ? 'bg-green-500 animate-pulse' : 'bg-gray-400']" />
          ...
          <div class="flex items-start justify-between">
            <div class="flex-1">
              ...
              <div class="mt-2 flex flex-wrap gap-x-6 gap-y-1 text-sm text-gray-600">
                ...
                <div
                  v-if="alert.geo_city || alert.geo_country"
                ...
                <div
                  v-if="alert.user_agent"
                  class="flex items-center max-w-xs truncate"
                  :title="alert.user_agent"
                >
                  <svg
                    class="w-4 h-4 mr-1 text-gray-400"
                    fill="none"
