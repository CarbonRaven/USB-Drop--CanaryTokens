...
const loadCampaign = async () => {
  ...
  try {
    ...
    editForm.value = {
      ...
      landing_page_config: campaign.value.landing_page_config || {
        mode: 'disabled',
  ...
  <div>
    ...
    <div v-else-if="campaign">
      ...
      <div class="mb-6 flex space-x-4">
        <router-link
          :to="`/drives?campaign_id=${campaign.id}`"
          class="px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700"
        >
          View All Drives
        </router-link>
        <router-link
          :to="`/map?campaign_id=${campaign.id}`"
      ...
      <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b flex justify-between items-center">
          ...
          <router-link
            :to="`/drives?action=new&campaign_id=${campaign.id}`"
        ...
        >
          ...
          <div class="border-t pt-4 mt-4">
            ...
            <p class="text-xs text-gray-500 mb-3">
              Configure the landing page shown when canary tokens are triggered. This applies to all drives in this campaign.
            </p>
            ...
            <div class="space-y-3">
              <div>
                ...
                <select
                  v-model="editForm.landing_page_config.mode"
                  class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md"
                >
              ...
              <div v-if="editForm.landing_page_config.mode === 'included'">
                <label class="block text-sm font-medium text-gray-700">Theme</label>
                <div class="mt-1 flex space-x-2">
                  <select
                    v-model="editForm.landing_page_config.included_theme"
                  ...
                  <button
                    ...
                    @click="openPreview(editForm.landing_page_config.included_theme)"
                  >
                    Preview
                  </button>
                </div>
              ...
              <div v-if="editForm.landing_page_config.mode === 'custom_url'">
                <label class="block text-sm font-medium text-gray-700">Custom URL</label>
                <input
                  v-model="editForm.landing_page_config.custom_url"
                  type="url"
              ...
              <div v-if="editForm.landing_page_config.mode !== 'disabled'">
                <label class="block text-sm font-medium text-gray-700">Redirect Delay (seconds)</label>
                <input
                  v-model.number="editForm.landing_page_config.delay_seconds"
                  type="number"
                  min="1"
                  max="30"
                  class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md"
                >
                <p class="mt-1 text-xs text-gray-500">Time before redirecting to final destination (1-30 seconds)</p>
              </div>
            </div>
          </div>
