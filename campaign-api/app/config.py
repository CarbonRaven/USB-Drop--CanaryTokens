...
class Settings(BaseSettings):
    ...
    factory_auth: str = ""
    webhook_url: str = ""  # URL for CanaryTokens to send alerts (e.g., https://api.subproject55.com/api/webhooks/canary)
    ...
    shlink_url: str = "http://shlink:8080"
    shlink_api_key: str = ""
    shlink_default_domain: str = "links.example.com"

    # Caddy Reverse Proxy
    caddy_admin_url: str = "http://caddy:2019"
    caddyfile_path: str = "/app/Caddyfile"
