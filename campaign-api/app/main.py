...
from app.routers import auth, campaigns, profiles, drives, tokens, webhooks, alerts, generate, reports, targets, shortener
...
async def lifespan(app: FastAPI):
    ...
    from app.services.profile_seeder import seed_default_profiles
...
# Create FastAPI app
# Disable docs in production (set DEBUG=true in .env to enable)
app = FastAPI(
...
app.include_router(shortener.router, prefix="/api/shortener", tags=["URL Shortener"])
