...
class Drive(Base):
    ...
    # URL shortener configuration (overrides profile settings)
    url_config = Column(JSONB, default=dict)
    ...
    deployment = relationship("Deployment", back_populates="drive", uselist=False, cascade="all, delete-orphan")
    short_urls = relationship("ShortUrl", back_populates="drive", cascade="all, delete-orphan")
