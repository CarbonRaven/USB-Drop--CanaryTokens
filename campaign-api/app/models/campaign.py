...
class Campaign(Base):
    ...
    # Landing page configuration for all tokens in this campaign
    # Structure: {
    #   "mode": "included" | "custom_url" | "disabled",
    #   "included_theme": "corporate|login|maintenance|helpdesk|hrportal|fileshare|training|banking|document|survey|onlyfans",
    #   "custom_url": "https://...",
